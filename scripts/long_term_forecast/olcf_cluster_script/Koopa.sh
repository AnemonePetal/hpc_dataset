...
# This script evaluates Koopa on OLCF dataset for long_term_forecast.
...
MODEL_NAME="Koopa" # This remains specific to this model's script
# PRED_LENS=(${PRED_LENS_STR}) # Reconstruct PRED_LENS array from the exported string
PRED_LENS=(30) # must be half of seq_len !!!!!
